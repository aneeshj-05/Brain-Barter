...
import { Search, Users, Book, Zap, Globe, TrendingUp, MessageCircle, Bell, Check, X, Send, Trash2 } from "lucide-react";
            ...
            <div style={styles.profileHeader}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={styles.profileCredits}>
                  💰 {selectedUserProfile.credits || 0} Credits
                </div>
                ...
                <div style={styles.headerRating}>
                  ...
                  <div style={styles.ratingText}>
                    {selectedUserProfile.averageRating ? selectedUserProfile.averageRating.toFixed(1) : 'No ratings'}
                  </div>
            ...
            <div style={styles.profileBody}>
              ...
              <div style={styles.profileSection}>
                ...
                {selectedUserProfile.reviews && selectedUserProfile.reviews.length > 0 ? (
                  selectedUserProfile.reviews.slice(0, 2).map((review, idx) => (
